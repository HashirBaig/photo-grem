  ...
  return (function (t) {
    ...
    function (t, e, r) {
      ...
      const n = Symbol("thread.errors"),
        i = Symbol("thread.events"),
        o = Symbol("thread.terminate"),
        s = Symbol("thread.transferable"),
        a = Symbol("thread.worker");
    },
    function (t, e) {
      var r;
      r = (function () {
    ...
    function (t, e, r) {
      ...
      function n(t, e) {
        ...
        let c = u < 0 ? -1 * u : 0,
          l = u <= 0 ? 0 : u,
          f = Math.max(s, a) + 1 + Math.max(r - s, n - a) - 1,
          h = 0;
        for (; h < f; ) {
          const r = h - c,
            n = r === s ? "." : t[r] || "0",
    ...
    function (t, e, r) {
      ...
      function i(t, e) {
        const r = t.length,
          ...
          u = -1 === s ? i : s;
        if (-1 === o && -1 === s && r < n && i < n)
          return (Number(t) + Number(e)).toFixed();
        const c = a - u;
        let l = Math.max(a, u),
          f = Math.max(r - a - 1, i - u - 1),
          h = c < 0 ? -1 * c : 0,
          d = c <= 0 ? 0 : c,
          p = l + 1 + f - 1,
          y = "",
          ...
          u ||
            (u = (function () {
              ...
              class t extends Worker {
                constructor(t, e) {
                  var r, n;
                  "string" == typeof t && e && e._baseURL
                    ? (t = new URL(t, e._baseURL))
                    : "string" == typeof t &&
                      !s(t) &&
                      i().match(/^file:\/\//i) &&
                      ((t = new URL(t, i().replace(/\/[^\/]+$/, "/"))),
                      (null === (r = null == e ? void 0 : e.CORSWorkaround) ||
                        void 0 === r ||
                        r) &&
                        (t = a(`importScripts(${JSON.stringify(t)});`))),
                    "string" == typeof t &&
                      s(t) &&
                      (null === (n = null == e ? void 0 : e.CORSWorkaround) ||
                        void 0 === n ||
                        n) &&
                      (t = a(`importScripts(${JSON.stringify(t)});`)),
                    super(t, e);
              ...
              class e extends t {
                ...
                static fromText(t, r) {
                  const n = new window.Blob([t], { type: "text/javascript" });
                  return new e(n, r);
                }
              }
              return { blob: e, default: t };
            })()),
          u
        );
      }
    ...
    function (t, e, r) {
      ...
      function l(t) {
        let e = t.constructor;
        return (
          void 0 !== e && ((e = e[u]), null === e && (e = void 0)),
          void 0 !== e ? e : v
        );
      }
      function f(t) {
      ...
      function g(t, e, r) {
        if ("closed" !== t._state)
          return "buffering" === t._state
            ? ((t._queue = t._queue || []),
              void t._queue.push({ type: e, value: r }))
            : "ready" !== t._state
            ? ((t._state = "buffering"),
              ...
              void h(() =>
                (function (t) {
                  ...
                  if (e) {
                    ...
                    for (const r of e)
                      if ((y(t, r.type, r.value), "closed" === t._state)) break;
                  }
                })(t)
              ))
            : void y(t, e, r);
      ...
      class v {
        ...
        forEach(t) {
          return new Promise((e, r) => {
            if ("function" != typeof t)
              return void r(new TypeError(t + " is not a function"));
            function n() {
      ...
      n() &&
        Object.defineProperty(v, Symbol("extensions"), {
          value: { symbol: a, hostReportError: f },
          configurable: !0,
        });
      e.a = v;
    },
    ...
    function (t, e, r) {
      ...
      function a(
        ...
        {
          format: r = "string",
          max_decimal_digits: a = 100,
          ellipsis: u = !1,
        } = {}
      ) {
        "0" === t[0] && (t = t.substring(1)),
          "0" === e[0] && (e = e.substring(1));
        const c = t.indexOf("."),
          l = e.indexOf("."),
          f = -1 === c ? t.length : c,
          h = -1 === l ? 0 : e.length - 1 - l;
        let d = !1;
        ...
        if (w === x) _ = 0;
          ...
          w < x
            ? ((m = m.substring(0, w) + "." + m.substring(w)), (_ = x - w))
            : 0 === w && ((m = "0." + m), (_ = x));
        (m = m.replace(/^0+/, "")), (m = m.replace(/\.\d+0+$/, ""));
        const S = _ - a;
        return (
          d || (S > 0 && (m = s(m.substring(0, m.length - S + 1)))),
          "." === m[0] && (m = "0" + m),
          "object" === r ? { quotient: m, extra_decimals: S } : m
        );
      }
      (t.exports = a), (t.exports.default = a);
    },
    ...
    function (t, e, r) {
      ...
      function b(
        ...
        e,
        {
          zero_to_the_power_of_zero: r = "1",
          ellipsis: b = !1,
          imaginary: v = !0,
          max_decimal_digits: w = 100,
          fraction: x = !1,
        } = {}
      ) {
        (t = i(t)), (e = i(e));
        ...
        if ("+" === E && k) {
          let r = h(t, e);
          return (
            "number" == typeof w && (r = y(r, { digits: w })),
            _ && c(e) && (r += "i"),
            r
          );
        }
        if ("-" === E && k) {
          const r = "1",
            i = h(t, n(e));
          return o(r, i, { ellipsis: b, max_decimal_digits: w });
        }
        if (!k) {
          e = n(e);
          let [r, i] = e.includes("/") ? e.split("/") : s(e);
          [r, i] = m(r, i);
          let o = p(t, i, { imaginary: v }),
            a = f(r, o);
          return (
            "number" == typeof w && (a = y(a, { digits: w })),
            "-" === E && (a = d(a, { fraction: x, max_decimal_digits: w })),
            a
          );
        }
      }
    ...
    function (t, e, r) {
      ...
      function o(t, { digits: e = 0 } = {}) {
        return n(t)
          ? i(t.substring(0, t.length - 1), { digits: e }) + "i"
          : i(t, { digits: e });
      }
      (t.exports = o), (t.exports.default = o);
    },
    function (t, e, r) {
      ...
      function f(
        t,
        e,
        { imaginary: r = !0, max_decimal_digits: f = 100 } = {}
      ) {
      ...
      (i.prototype.parse = function (t, e, r) {
        ...
        if (!y[w] && (_ || (w && !g[w]))) {
          for (var S, A, E = -1, k = 0; k < f.length; k++) {
            -1 !== (T = b.indexOf(f[k])) && (-1 === E || T < E) && (E = T);
          }
          -1 !== (A = -1 === E ? b.lastIndexOf("@") : b.lastIndexOf("@", E)) &&
            ((S = b.slice(0, A)),
            (b = b.slice(A + 1)),
          ...
          if (!O)
            for (
              var C = this.hostname.split(/\./), P = ((k = 0), C.length);
              k < P;
              k++
            ) {
              var I = C[k];
        ...
        (i.prototype.resolveObject = function (t) {
          ...
          for (
            var r = new i(), n = Object.keys(this), o = 0;
            o < n.length;
            o++
          ) {
            var s = n[o];
          ...
          var O,
            C = "" === _[0] || (_[0] && "/" === _[0].charAt(0));
          S &&
            ((r.hostname = C ? "" : _.length ? _.shift() : ""),
            (r.host = r.hostname),
            (O = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) &&
              ...
              (r.host = r.hostname)));
          return (
            (w = w || (r.host && _.length)) && !C && _.unshift(""),
            _.length > 0
              ? (r.pathname = _.join("/"))
      ...
      var u = function () {
        ...
        h =
          ...
          (f
            ...
            : null),
        d = {},
        p = "undefined" != typeof Uint8Array && h ? h(Uint8Array) : void 0,
        y = {
          "%AggregateError%":
    ...
    function (t, e, r) {
      ...
      function i(t, e) {
        ...
        const r = t.indexOf("."),
          i = e.indexOf("."),
          o = (-1 === r ? t.length : r) + (-1 === i ? e.length : i),
          s =
            (-1 === r ? 0 : t.length - 1 - r) +
            (-1 === i ? 0 : e.length - 1 - i);
        ...
        for (let t = 0, e = l - 1; e >= 0; e--, t++) {
          ...
          f.forEach(([t, e], r) => {
            ...
            (o += "0".repeat(t)),
            d.push(o),
            p.push([Array.from(o).map((t) => Number(t)), o.length]);
        }
        const y = d.length,
          g = p[p.length - 1][1] + y;
        let m = "",
        ...
        for (let t = 0; t < g; t++) {
          ...
          e >= 10
            ? ((e = e.toString()),
              (m = e[e.length - 1] + m),
              (b = Number(e.slice(0, -1))))
            : ((m = e + m), (b = 0));
        }
        if (0 === s) m = m.replace(/^0+/, "");
        else {
          const t = m.length - s;
          (m = m.substring(0, t) + "." + m.substring(t)),
            (m = m.replace(/^0+/, "")),
            (m = m.replace(/\.?0+$/, "")),
            "." === m[0] && (m = "0" + m);
        }
    ...
    function (t, e, r) {
      ...
      function i() {
        const t = Array.from(arguments),
          e = "object" == typeof t[t.length - 1] ? t[t.length - 1] : void 0,
          r = Array.isArray(t[0]) ? t[0] : e ? t.slice(0, t.length - 1) : t;
        return n(r, e);
      }
      (t.exports = i), (t.exports.default = i);
    },
    ...
    function (t, e, r) {
      ...
      (function (t) {
        ...
        const h = i()("threads:master:messages"),
          d = i()("threads:master:spawn"),
          p = i()("threads:master:thread-utils"),
          y =
            void 0 !== t && t.env.THREADS_WORKER_INIT_TIMEOUT
              ? Number.parseInt(t.env.THREADS_WORKER_INIT_TIMEOUT, 10)
              : 1e4;
        function g(t, e, r, n) {
          const i = r
            .filter((t) => t.type === c.a.internalError)
            .map((t) => t.error);
          return Object.assign(t, { [u.a]: i, [u.b]: r, [u.c]: n, [u.e]: e });
        }
        function m(t, e) {
          return f(this, void 0, void 0, function* () {
            d("Initializing new thread");
            const r = e && e.timeout ? e.timeout : y,
              n = (yield (function (t, e, r) {
                return f(this, void 0, void 0, function* () {
                  let n;
                  ...
                  return new Promise((e, r) => {
                    const n = (i) => {
                      ...
                      h(
                        ...
                        (o = i.data) && "init" === o.type
                          ? (t.removeEventListener("message", n), e(i.data))
                          : ((t) => t && "uncaughtError" === t.type)(i.data) &&
                            (t.removeEventListener("message", n),
                            r(Object(s.a)(i.data.error)));
                    };
              ...
              { termination: i, terminate: u } = (function (t) {
              ...
              m = (function (t, e) {
                return new o.a((r) => {
                  ...
                  t.addEventListener("message", n),
                    t.addEventListener("unhandledrejection", i),
                    e.then(() => {
                      const e = { type: c.a.termination };
                      t.removeEventListener("message", n),
                        t.removeEventListener("unhandledrejection", i),
                        r.next(e),
                        r.complete();
                    });
                });
            ...
            if ("function" === n.type) {
              return g(Object(l.a)(t), t, m, u);
            }
            if ("module" === n.type) {
              return g(Object(l.b)(t, n.methods), t, m, u);
            }
            {
              const t = n.type;
              throw Error(
                "Worker init message states unexpected type of expose(): " + t
              );
            }
          });
        }
    ...
    function (t, e, r) {
      ...
      function u(t) {
        return Promise.all(
          t.map((t) => {
            const e = (t) => ({ status: "fulfilled", value: t }),
              r = (t) => ({ status: "rejected", reason: t }),
              n = Promise.resolve(t);
            try {
              return n.then(e, r);
            } catch (t) {
      ...
      !(function (t) {
        (t.initialized = "initialized"),
          (t.taskCanceled = "taskCanceled"),
          (t.taskCompleted = "taskCompleted"),
          (t.taskFailed = "taskFailed"),
          (t.taskQueued = "taskQueued"),
          (t.taskQueueDrained = "taskQueueDrained"),
      ...
      class p {
        constructor(t, e) {
          (this.eventSubject = new o.a()),
            (this.initErrors = []),
            (this.isClosing = !1),
            (this.nextTaskID = 1),
            (this.taskQueue = []);
          const r = "number" == typeof e ? { size: e } : e || {},
            { size: n = l.a } = r;
          (this.debug = i()(
            "threads:pool:" +
              (r.name || String(d++))
            ...
            (this.workers = (function (t, e) {
              return (function (t) {
                ...
                return e;
              })(e).map(() => ({ init: t(), runningTasks: [] }));
            })(t, n)),
            (this.eventObservable = Object(s.a)(a.a.from(this.eventSubject))),
            Promise.all(this.workers.map((t) => t.init)).then(
              () =>
              ...
              (t) => {
                this.debug("Error while initializing pool worker:", t),
                  this.eventSubject.error(t),
        ...
        runPoolTask(t, e) {
          return h(this, void 0, void 0, function* () {
            ...
            this.debug(`Running task #${e.id} on worker #${r}...`),
              this.eventSubject.next({
                type: c.taskStart,
                taskID: e.id,
                workerID: r,
            ...
            try {
              ...
              this.debug(`Task #${e.id} completed successfully`),
                this.eventSubject.next({
            ...
            const r = (() =>
              h(this, void 0, void 0, function* () {
                ...
                try {
                  ...
                  (t.runningTasks = t.runningTasks.filter((t) => t !== r)),
        ...
        scheduleWork() {
          ...
          if (!e)
            return (
              ...
              void this.eventSubject.next({ type: c.taskQueueDrained })
            );
          this.run(t, e);
        }
        taskCompletion(t) {
          return new Promise((e, r) => {
            const n = this.events().subscribe((i) => {
              i.type === c.taskCompleted && i.taskID === t
                ? (n.unsubscribe(), e(i.returnValue))
                : i.type === c.taskFailed && i.taskID === t
        ...
        completed(t = !1) {
          return h(this, void 0, void 0, function* () {
            const e = this.settled(t),
              r = new Promise((t, r) => {
                const n = this.eventObservable.subscribe({
                  next(i) {
                    i.type === c.taskQueueDrained
                      ? (n.unsubscribe(), t(e))
                      : i.type === c.taskFailed &&
                        (n.unsubscribe(), r(i.error));
                  },
        ...
        queue(t) {
          const { maxQueuedJobs: e = 1 / 0 } = this.options;
          if (this.isClosing)
            throw Error(
          ...
          const i = {
            ...
            cancel: () => {
              -1 !== this.taskQueue.indexOf(i) &&
                ((this.taskQueue = this.taskQueue.filter((t) => t !== i)),
                this.eventSubject.next({ type: c.taskCanceled, taskID: i.id }));
            },
            then: n.then.bind(n),
          };
          if (this.taskQueue.length >= e)
            throw Error(
          ...
          return (
            ...
            this.eventSubject.next({ type: c.taskQueued, taskID: i.id }),
            this.scheduleWork(),
            i
          );
        }
    ...
    function (t, e, r) {
      ...
      class h extends o.a {
        ...
        onNext(t) {
          this.firstValueSet ||
            ((this.firstValue = t), (this.firstValueSet = !0));
        }
        onError(t) {
        ...
        return new o.a((r) => {
          ...
          const i = (o) => {
            ...
            if ((y("Message from worker:", o.data), o.data && o.data.uid === e))
              ...
              else if (((t) => t && t.type === p.b.result)(o.data))
                "promise" === n
                  ? (void 0 !== o.data.payload &&
                      r.next(Object(a.a)(o.data.payload)),
                    r.complete(),
                    t.removeEventListener("message", i))
                  : (o.data.payload && r.next(Object(a.a)(o.data.payload)),
                    o.data.complete &&
                      (r.complete(), t.removeEventListener("message", i)));
      ...
      function b(t, e) {
        return (...r) => {
          const n = g++,
            { args: i, transferables: o } = (function (t) {
              if (0 === t.length) return { args: [], transferables: [] };
              const e = [],
                r = [];
              for (const n of t)
                Object(d.a)(n)
                  ? (e.push(Object(a.b)(n.send)), r.push(...n.transferables))
                  : e.push(Object(a.b)(n));
              return {
                args: e,
                transferables:
                  0 === r.length ? r : ((n = r), Array.from(new Set(n))),
              };
              var n;
            })(r),
            u = { type: p.a.run, uid: n, method: e, args: i };
        ...
        (v.prototype.read = function (t) {
          ...
          return (
            ...
            null === (n = t > 0 ? P(t, e) : null)
              ...
              : (e.length -= t),
            0 === e.length &&
              (e.ended || (e.needReadable = !0), r !== t && e.ended && I(this)),
          ...
          if (t._writev && r && r.next) {
            ...
            for (; r; ) {
              var c = r.chunk,
                ...
                f = r.callback;
              if (
                (v(t, e, !1, e.objectMode ? 1 : c.length, c, l, f),
                (r = r.next),
        ...
        c.inherits(b, f),
            ...
            ? ((p = Function.prototype[Symbol.hasInstance]),
              Object.defineProperty(b, Symbol.hasInstance, {
                value: function (t) {
                  return (
                    !!p.call(this, t) ||
                    (this === b && t && t._writableState instanceof m)
                  );
                },
              }))
            : (p = function (t) {
          ...
          (b.prototype.write = function (t, e, r) {
            var n,
              ...
              s = !1,
              a = !i.objectMode && ((n = t), h.isBuffer(n) || n instanceof d);
            return (
              a &&
                !h.isBuffer(t) &&
                (t = (function (t) {
    ...
    function (t, e, r) {
      ...
      function h(t) {
        let e = 0,
          r = t.length;
        return o(() => (e++ < r ? { value: t[e], done: !1 } : { done: !0 }));
      }
      function d(t) {
        if (l(t)) return t;
        ...
        zip: function (t) {
          return (
            ...
            o(function () {
              ...
              return e.every(({ done: t }) => t)
                ? { done: !0 }
                : { done: !1, value: e.map(({ value: t }) => t) };
            })
          );
        },
      };
    ...
    function (t, e, r) {
      ...
      function n(t) {
        ...
        let n = t.indexOf(".");
        -1 === n && (n = r);
        const i = Number(t.substring(r + 1)),
          o = t.substring(0, r).replace(".", ""),
          s = n + i,
          a = o.length;
        if (s >= a) {
          const t = s - a;
    ...
    function (t, e, r) {
      ...
      function o(t) {
        ...
        return ["1", "3", "5", "7", "9"].includes(t.charAt(t.length - 1));
      }
      (t.exports = o), (t.exports.default = o);
    },
    function (t, e, r) {
      ...
      function c(
        t,
        { max_decimal_digits: e, infinity_times_zero: r = "NaN" } = {}
      ) {
        const c = t.some((t) => i(t)),
          l = t.some((t) => s(t));
        if (c && l) return r;
        if (c) {
          return t.filter((t) => "-" === u(t)).length % 2 == 0
            ? "Infinity"
            : "-Infinity";
        }
        if (l) return "0";
    ...
    function (t, e, r) {
      ...
      function o(t) {
        ...
        return ["0", "2", "4", "6", "8"].includes(t.charAt(t.length - 1));
      }
      (t.exports = o), (t.exports.default = o);
    },
    function (t, e, r) {
    ...
    function (t, e, r) {
      ...
      const n = r(1),
        ...
        s = r(87);
      function a(t, e) {
        const r = s("2", o(["1000", e, e]));
        for (; t.endsWith("0") && e.endsWith("0"); )
        ...
        for (; a; ) {
          ...
          for (let i = 0; i < r.length; i++) {
            const o = r[i],
              s = o.length + 1,
              u = n(t, o, { ellipsis: !0, max_decimal_digits: s });
            if (-1 === u.indexOf(".")) {
              const r = n(e, o, { ellipsis: !0, max_decimal_digits: s });
              if (-1 === r.indexOf(".")) {
                (t = u), (e = r), (a = !0);
                break;
              }
    ...
    function (t, e, r) {
      ...
      function a(t = "0", e = "100") {
        ...
        for (; ">" !== n(a, e); )
          /^\d+5/.test(a) ||
            /^(\d)\1+/.test(a) ||
            (["9", "7", "3"].every((t) => !o(i(a, t))) && r.push(a)),
            (a = s(a, "2"));
        return r;
      }
      (t.exports = a), (t.exports.default = a);
    ...
    function (t, e, r) {
      ...
      function o({ max_decimal_digits: t = 100, steps: e = 100 } = {}) {
        let r = "1",
          o = "1";
        for (let s = 1; s < e; s++)
          (o = i(o, s.toString(), { max_decimal_digits: t })), (r = n(r, o));
        return r;
      }
      (t.exports = o), (t.exports.default = o);
    },
    function (t, e, r) {
      ...
      function c(t, { max_decimal_digits: e = 100 } = {}) {
        ...
        return i(t)
          ...
          : s(t)
          ? "1"
          : ((t = n(t)), u(r, t, { max_decimal_digits: e }));
      }
      (t.exports = c), (t.exports.default = c);
    },
    function (t, e, r) {
    ...
    function (t, e, r) {
      ...
      var i = {};
      r.r(i),
        r.d(i, "fromWhiteIsZero", function () {
          return m;
        }),
      ...
      const d = {
        ...
        p = { Unspecified: 0, Assocalpha: 1, Unassalpha: 2 },
        y = {
      ...
      function b(t, e) {
        ...
        let o;
        for (let r = 0, n = 0; r < t.length; ++r, n += 3)
          (o = (t[r] / e) * 256), (i[n] = o), (i[n + 1] = o), (i[n + 2] = o);
        return i;
      }
      function v(t, e) {
        const { width: r, height: n } = t,
        ...
        for (let r = 0, n = 0; r < t.length; ++r, n += 3) {
          const a = t[r];
          (i[n] = (e[a] / 65536) * 256),
            (i[n + 1] = (e[a + o] / 65536) * 256),
            (i[n + 2] = (e[a + s] / 65536) * 256);
        }
        return i;
      }
      function w(t) {
        const { width: e, height: r } = t,
          n = new Uint8Array(e * r * 3);
        for (let e = 0, r = 0; e < t.length; e += 4, r += 3) {
          const i = t[e],
            o = t[e + 1],
            s = t[e + 2],
            a = t[e + 3];
          (n[r] = ((255 - i) / 256) * 255 * ((255 - a) / 256)),
            (n[r + 1] = ((255 - o) / 256) * 255 * ((255 - a) / 256)),
            (n[r + 2] = ((255 - s) / 256) * 255 * ((255 - a) / 256));
        }
        return n;
      }
      function x(t) {
        ...
        for (let e = 0, r = 0; e < t.length; e += 3, r += 3) {
          const i = t[e],
            ...
            s = t[e + 2];
          (n[r] = i + 1.402 * (s - 128)),
            (n[r + 1] = i - 0.34414 * (o - 128) - 0.71414 * (s - 128)),
            (n[r + 2] = i + 1.772 * (o - 128));
        }
        return n;
      }
      function _(t) {
        ...
        for (let e = 0, r = 0; e < t.length; e += 3, r += 3) {
          ...
          (u =
            ...
            (i = 3.2406 * u + -1.5372 * a + -0.4986 * c),
            (o = -0.9689 * u + 1.8758 * a + 0.0415 * c),
            (s = 0.0557 * u + -0.204 * a + 1.057 * c),
            ...
            (n[r] = 255 * Math.max(0, Math.min(1, i))),
            (n[r + 1] = 255 * Math.max(0, Math.min(1, o))),
            (n[r + 2] = 255 * Math.max(0, Math.min(1, s)));
        }
        return n;
      }
      function S(t, e) {
      ...
      function A(t, e, r) {
        ...
        const s = t.slice();
        for (let e = 0; e < o; ++e)
          for (let n = 0; n < r; ++n) t[r * e + n] = s[(r - n - 1) * o + e];
      }
      class E {
        decode(t, e) {
          const r = this.decodeBlock(e),
            n = t.Predictor || 1;
          if (1 !== n) {
              ...
              for (let o = 0; o < n && !(o * a * r * s >= t.byteLength); ++o) {
                ...
                if (2 === e) {
                  switch (i[0]) {
                    ...
                    default:
                      throw new Error(
                        `Predictor 2 not allowed with ${i[0]} bits per sample.`
                      );
                  }
                  S(n, a);
                } else
      ...
      function O(t) {
        ...
        for (; 257 !== d; ) {
          if (256 === d) {
            ...
            if (!t)
              throw new Error(
                `Bogus entry. Not in dictionary, ${h} / ${n}, position: ${o}`
              );
      ...
      function I(t, e) {
        ...
        for (let a = 0; a < i; a++) {
          for (let i = 0; i < t[a]; i++) {
            for (s = n.pop(), s.children[s.index] = e[r]; s.index > 0; )
              s = n.pop();
            for (s.index++, n.push(s); n.length <= a; )
      ...
      function R(t, e, r, n, i, o, s, a, u) {
        const { mcusPerLine: c, progressive: l } = r,
          f = e;
        let h = e,
          d = 0,
          p = 0;
          ...
          if (((v = 0), 1 === A))
            ...
            for (C = 0; C < L; C++) {
              for (k = 0; k < A; k++) {
                ...
                const { h: t, v: e } = E;
                for (T = 0; T < e; T++)
                  for (O = 0; O < t; O++) _(E, I, M, T, O);
              }
              if ((M++, M === j)) break;
            }
          if (((p = 0), (R = (t[h] << 8) | t[h + 1]), R < 65280))
      ...
      function j(t, e) {
        const r = [],
          { blocksPerLine: n, blocksPerColumn: i } = e,
          o = n << 3,
          s = new Int32Array(64),
          a = new Uint8Array(64);
        function u(t, r, n) {
          ...
          for (y = 0; y < 8; ++y) {
            ...
            0 !== p[7 + t]
              ? ((o = (5793 * p[0 + t] + 128) >> 8),
                ...
                (a = p[2 + t]),
                (u = p[6 + t]),
                (c = (2896 * (p[1 + t] - p[7 + t]) + 128) >> 8),
                (h = (2896 * (p[1 + t] + p[7 + t]) + 128) >> 8),
                (l = p[3 + t] << 4),
                (f = p[5 + t] << 4),
                (d = (o - s + 1) >> 1),
                (o = (o + s + 1) >> 1),
                (s = d),
                (d = (3784 * a + 1567 * u + 128) >> 8),
                (a = (1567 * a - 3784 * u + 128) >> 8),
                (u = d),
                (d = (c - f + 1) >> 1),
                (c = (c + f + 1) >> 1),
                (f = d),
                ...
                (s = (s + a + 1) >> 1),
                (a = d),
                (d = (2276 * c + 3406 * h + 2048) >> 12),
                (c = (3406 * c - 2276 * h + 2048) >> 12),
                (h = d),
                (d = (799 * l + 4017 * f + 2048) >> 12),
                (l = (4017 * l - 799 * f + 2048) >> 12),
                (f = d),
                (p[0 + t] = o + h),
                (p[7 + t] = o - h),
                (p[1 + t] = s + f),
          ...
          for (y = 0; y < 8; ++y) {
            ...
            0 !== p[48 + t] ||
            0 !== p[56 + t]
              ? ((o = (5793 * p[0 + t] + 2048) >> 12),
                (s = (5793 * p[32 + t] + 2048) >> 12),
                (a = p[16 + t]),
                (u = p[48 + t]),
                (c = (2896 * (p[8 + t] - p[56 + t]) + 2048) >> 12),
                (h = (2896 * (p[8 + t] + p[56 + t]) + 2048) >> 12),
                (l = p[24 + t]),
                (f = p[40 + t]),
                (d = (o - s + 1) >> 1),
                (o = (o + s + 1) >> 1),
                (s = d),
                (d = (3784 * a + 1567 * u + 2048) >> 12),
                (a = (1567 * a - 3784 * u + 2048) >> 12),
                (u = d),
                (d = (c - f + 1) >> 1),
                (c = (c + f + 1) >> 1),
                (f = d),
          ...
          function i(t) {
            ...
            for (r in t.components)
              t.components.hasOwnProperty(r) &&
                ...
                n < e.h && (n = e.h),
                i < e.v && (i = e.v));
            const o = Math.ceil(t.samplesPerLine / 8 / n),
              s = Math.ceil(t.scanLines / 8 / i);
            for (r in t.components)
              if (t.components.hasOwnProperty(r)) {
                e = t.components[r];
                const a = Math.ceil(
                    (Math.ceil(t.samplesPerLine / 8) * e.h) / n
                  ),
                  u = Math.ceil((Math.ceil(t.scanLines / 8) * e.v) / i),
                  c = o * e.h,
                  l = s * e.v,
                  f = [];
                for (let t = 0; t < l; t++) {
            ...
            switch (o) {
              ...
              case 65474: {
                ...
                for (let r = 0; r < s; r++) {
                  ...
                  const r = t[e + 1] >> 4,
                    i = 15 & t[e + 1],
                    o = t[e + 2];
                  n.componentsOrder.push(a),
                    (n.components[a] = { h: r, v: i, quantizationIdx: o }),
                    (e += 3);
                }
              ...
              case 65476: {
                ...
                for (let r = 2; r < n; ) {
                  ...
                  (r += 17 + o),
                    n >> 4 == 0
                      ? (this.huffmanTablesDC[15 & n] = I(i, s))
                      : (this.huffmanTablesAC[15 & n] = I(i, s));
                }
                break;
              }
              case 65501:
              ...
              case 65498: {
                ...
                const n = t[e++],
                  ...
                  o = this.frames[0];
                for (let r = 0; r < n; r++) {
                  const r = o.components[t[e++]],
                    n = t[e++];
                  (r.huffmanTableDC = this.huffmanTablesDC[n >> 4]),
                    (r.huffmanTableAC = this.huffmanTablesAC[15 & n]),
                    i.push(r);
                }
                const s = t[e++],
                  a = t[e++],
                  u = t[e++],
                  c = R(t, e, o, i, this.resetInterval, s, a, u >> 4, 15 & u);
                e += c;
                break;
              }
              case 65535:
        ...
        getResult() {
          ...
          for (let t = 0; t < this.frames.length; t++) {
            ...
            for (const t of Object.keys(e))
              (e[t].quantizationTable =
                this.quantizationTables[e[t].quantizationIdx]),
                delete e[t].quantizationIdx;
          }
          const e = t[0],
            { components: r, componentsOrder: n } = e,
            i = [],
            o = e.samplesPerLine,
            s = e.scanLines;
      ...
      function U(t) {
        switch (t.Compression) {
          ...
          default:
            throw new Error(
              "Unknown compression method identifier: " + t.Compression
            );
        }
      }
            ...
            return (function (t, e, r, n, i) {
              ...
              return t.map((t) => {
                ...
                for (let u = 0; u < i; ++u) {
                  ...
                  for (let r = 0; r < n; ++r) {
                    const s = Math.min(Math.round(o * r), e - 1),
                      c = t[i * e + s];
                    a[u * n + r] = c;
                  }
                }
            ...
            return (function (t, e, r, n, i) {
              ...
              return t.map((t) => {
                ...
                for (let u = 0; u < i; ++u) {
                  const i = s * u,
                    c = Math.floor(i),
                    l = Math.min(Math.ceil(i), r - 1);
                  for (let r = 0; r < n; ++r) {
                    const s = o * r,
                      f = s % 1,
                      h = Math.floor(s),
                      d = Math.min(Math.ceil(s), e - 1),
                      p = t[c * e + h],
                      y = t[c * e + d],
                      g = t[l * e + h],
                      m = t[l * e + d],
                      b = G(G(p, y, f), G(g, m, f), i % 1);
                    a[u * n + r] = b;
                  }
                }
                return a;
          ...
          case "linear":
            return (function (t, e, r, n, i, o) {
              ...
              for (let c = 0; c < i; ++c) {
                const i = a * c,
                  l = Math.floor(i),
                  f = Math.min(Math.ceil(i), r - 1);
                for (let r = 0; r < n; ++r) {
                  const a = s * r,
                    h = a % 1,
                    d = Math.floor(a),
                    p = Math.min(Math.ceil(a), e - 1);
                  for (let s = 0; s < o; ++s) {
                    const a = t[l * e * o + d * o + s],
                      y = t[l * e * o + p * o + s],
                      g = t[f * e * o + d * o + s],
                      m = t[f * e * o + p * o + s],
                      b = G(G(a, y, h), G(g, m, h), i % 1);
                    u[c * n * o + r * o + s] = b;
                  }
                }
              }
      ...
      var V = class {
        constructor(t, e, r, n, i, o) {
          ...
          if (
            ((this.planarConfiguration = void 0 === s ? 1 : s),
        ...
        getSampleByteSize(t) {
          ...
          if (e % 8 != 0)
            throw new Error(`Sample bit-width of ${e} is not supported.`);
          return e / 8;
        }
        getReaderForSample(t) {
          const e = this.fileDirectory.SampleFormat
        ...
        getArrayForSample(t, e) {
          return W(
            this.fileDirectory.SampleFormat
              ? this.fileDirectory.SampleFormat[t]
              : 1,
            this.fileDirectory.BitsPerSample[t],
            e
          );
        }
        async getTileOrStrip(t, e, r, n) {
          ...
          1 === this.planarConfiguration
            ? (s = e * i + t)
            : 2 === this.planarConfiguration && (s = r * i * o + e * i + t),
            this.isTiled
              ? ((u = this.fileDirectory.TileOffsets[s]),
                (c = this.fileDirectory.TileByteCounts[s]))
              : ((u = this.fileDirectory.StripOffsets[s]),
                (c = this.fileDirectory.StripByteCounts[s]));
          const l = await this.source.fetch(u, c);
          let f;
          return (
            null === a
              ? (f = n.decode(this.fileDirectory, l))
              : a[s] || ((f = n.decode(this.fileDirectory, l)), (a[s] = f)),
            { x: t, y: e, sample: r, data: await f }
          );
        }
        async _readRaster(t, e, r, n, i, o, s, a) {
          const u = this.getTileWidth(),
            c = this.getTileHeight(),
            l = Math.max(Math.floor(t[0] / u), 0),
            f = Math.min(
              Math.ceil(t[2] / u),
              Math.ceil(this.getWidth() / this.getTileWidth())
            ),
            h = Math.max(Math.floor(t[1] / c), 0),
            d = Math.min(
              Math.ceil(t[3] / c),
          ...
          for (let t = 0; t < e.length; ++t)
            1 === this.planarConfiguration
              ? g.push(H(this.fileDirectory.BitsPerSample, 0, e[t]) / 8)
              : g.push(0),
              m.push(this.getReaderForSample(e[t]));
          const b = [],
            { littleEndian: v } = this;
          for (let o = h; o < d; ++o)
            for (let s = l; s < f; ++s)
                ...
                b.push(h),
                  h.then((i) => {
                    const o = i.data,
                      ...
                      d = (i.x + 1) * u,
                      b = m[l],
                      w = Math.min(c, c - (h - t[3])),
                      x = Math.min(u, u - (d - t[2]));
                    for (let i = Math.max(0, t[1] - a); i < w; ++i)
                      for (let o = Math.max(0, t[0] - f); o < x; ++o) {
                        const c = (i * u + o) * y,
                          h = b.call(s, c + g[l], v);
                        let d;
                        n
          ...
          if (
            (await Promise.all(b),
            (o && t[2] - t[0] !== o) || (s && t[3] - t[1] !== s))
          ) {
            let i;
            return (
              (i = n
                ? z(r, t[2] - t[0], t[3] - t[1], o, s, e.length, a)
                : q(r, t[2] - t[0], t[3] - t[1], o, s, a)),
              (i.width = o),
              (i.height = s),
              i
            );
        ...
        async readRasters({
          ...
          if (e && e.length) {
            for (let t = 0; t < e.length; ++t)
              if (e[t] >= this.fileDirectory.SamplesPerPixel)
                return Promise.reject(
                  new RangeError(`Invalid sample index '${e[t]}'.`)
                );
          } else
            for (let t = 0; t < this.fileDirectory.SamplesPerPixel; ++t)
              e.push(t);
          let l;
          if (r) {
            (l = W(
              this.fileDirectory.SampleFormat
                ...
                : 1,
              Math.max.apply(null, this.fileDirectory.BitsPerSample),
              c * e.length
            )),
              a && l.fill(a);
          } else {
            ...
            for (let t = 0; t < e.length; ++t) {
              ...
              Array.isArray(a) && t < a.length
                ? r.fill(a[t])
                : a && !Array.isArray(a) && r.fill(a),
                l.push(r);
            }
          }
        ...
        async readRGB({
          ...
          const s = t || [0, 0, this.getWidth(), this.getHeight()];
          ...
          const c = {
            ...
            f = await this.readRasters(c),
            h = 2 ** this.fileDirectory.BitsPerSample[0];
          let y;
          switch (a) {
            case d.WhiteIsZero:
              y = m(f, h);
        ...
        getOrigin() {
          const t = this.fileDirectory.ModelTiepoint,
        ...
        getResolution(t = null) {
          const e = this.fileDirectory.ModelPixelScale,
      ...
      class $ {
        ...
        getUint64(t, e) {
          const r = this.getUint32(t, e),
            n = this.getUint32(t + 4, e);
          let i;
          if (e) {
            if (((i = r + 2 ** 32 * n), !Number.isSafeInteger(i)))
              throw new Error(
                i +
          ...
          if (((i = 2 ** 32 * r + n), !Number.isSafeInteger(i)))
            throw new Error(
              i +
                " exceeds MAX_SAFE_INTEGER. Precision may be lost. Please report if you get this message to https://github.com/geotiffjs/geotiff.js/issues"
            );
      ...
      class K {
        ...
        readUint64(t) {
          const e = this.readUint32(t),
            r = this.readUint32(t + 4);
          let n;
          if (this._littleEndian) {
            if (((n = e + 2 ** 32 * r), !Number.isSafeInteger(n)))
              throw new Error(
                n +
                  " exceeds MAX_SAFE_INTEGER. Precision may be lost. Please report if you get this message to https://github.com/geotiffjs/geotiff.js/issues"
              );
          ...
          if (((n = 2 ** 32 * e + r), !Number.isSafeInteger(n)))
            throw new Error(
              n +
                " exceeds MAX_SAFE_INTEGER. Precision may be lost. Please report if you get this message to https://github.com/geotiffjs/geotiff.js/issues"
            );
        ...
        readInt64(t) {
          let e = 0;
          const r =
            (128 & this._dataView.getUint8(t + (this._littleEndian ? 7 : 0))) >
            0;
          let n = !0;
          for (let i = 0; i < 8; i++) {
      ...
      class it {
        ...
        async fetch(t, e, r = !1) {
          const n = t + e,
            ...
            s = [];
          for (
            let e = Math.floor(t / this.blockSize) * this.blockSize;
            e < n;
            e += this.blockSize
          ) {
            const t = Math.floor(e / this.blockSize);
            this.blocks.has(t) || this.blockRequests.has(t) || o.push(t),
              this.blockRequests.has(t) && s.push(this.blockRequests.get(t)),
              i.push(t);
          }
              ...
              for (let r = 0; r < e.length; ++r) {
                ...
                this.blockRequests.set(
                  ...
                  (async () => {
                    const e = await t,
                      i = r * this.blockSize,
                      o = Math.min(i + this.blockSize, e.data.byteLength),
                      s = e.data.slice(i, o);
          ...
          const a = [];
          for (const t of o)
            this.blockRequests.has(t) && a.push(this.blockRequests.get(t));
          ...
          return (function (t, e, r) {
            ...
            for (const r of t) {
              ...
              let s,
                ...
                u = 0;
              t < 0 ? (a = -t) : t > 0 && (u = t),
                (s = i < 0 ? r.length - a : n - r.offset - a);
              const c = new Uint8Array(r.data, a, s);
              o.set(c, u);
            }
            return i;
          })(
            i.map((t) => this.blocks.get(t)),
            t,
            e
          );
        }
        async requestData(t, e) {
          ...
          return (
            r.length
              ? r.length !== r.data.byteLength &&
                (r.data = r.data.slice(0, r.length))
              : (r.length = r.data.byteLength),
            (r.top = r.offset + r.length),
            r
          );
        }
      }
      function ot(t, e) {
        const { forceXHR: r } = e;
        if ("function" == typeof fetch && !r)
          return (function (t, { headers: e = {}, blockSize: r } = {}) {
            return new it(
              async (r, n) => {
                const i = await fetch(t, {
                  headers: { ...e, Range: `bytes=${r}-${r + n - 1}` },
                });
                if (i.ok) {
                  if (206 === i.status) {
                    return {
                  ...
                  }
                  {
                    const t = i.arrayBuffer
                      ? await i.arrayBuffer()
                      : (await i.buffer()).buffer;
                    return { data: t, offset: 0, length: t.byteLength };
                  }
                }
            ...
            return new it(
              async (r, n) =>
                new Promise((i, o) => {
                  ...
                  const a = { ...e, Range: `bytes=${r}-${r + n - 1}` };
                  for (const [t, e] of Object.entries(a))
                    s.setRequestHeader(t, e);
                  (s.onload = () => {
                    const t = s.response;
                    206 === s.status
                      ? i({ data: t, offset: r, length: n })
                      : i({ data: t, offset: 0, length: t.byteLength });
                  }),
                    (s.onerror = o),
                    s.send();
                }),
                      ...
                      (t) => {
                        ...
                        t.on("data", (t) => {
                          ...
                          t.on("end", () => {
                            ...
                            i({ data: t, offset: r, length: t.byteLength });
                          });
                      }
                    )
                    .on("error", o);
      ...
      function st(t) {
        ...
        return {
          async fetch(t, r) {
            const n = await e,
              { buffer: i } = await (function (...t) {
                return new Promise((e, r) => {
                  Object(X.read)(...t, (t, n, i) => {
                    t ? r(t) : e({ bytesRead: n, buffer: i });
                  });
                });
              })(n, Z.Buffer.alloc(r), 0, r, t);
            return i.buffer;
          },
          async close() {
            const t = await e;
      ...
      const pt = ct(f),
        yt = {
          ...
          readASCII: (t, e, r) =>
            r.map((r) => String.fromCharCode(t[e + r])).join(""),
          readFloat: (t, e) => {
            const r = yt.ui8;
            return (
              lt(4, (n) => {
      ...
      (yt.fl64 = new Float64Array(yt.ui8.buffer)),
        (yt.writeDouble = (t, e, r) => {
          (yt.fl64[0] = r),
            lt(8, (r) => {
              t[e + r] = yt.ui8[7 - r];
            });
            ...
            t.forEach((r, o) => {
              const s = ((t, e, r, n) => {
                ...
                for (const r of o) {
                  ...
                  const a = c[o],
                    u = pt[a];
                  if (null == a || void 0 === a || void 0 === a)
                    throw new Error("unknown type of tag: " + o);
                  let l = n[r];
                  if (void 0 === l)
                    throw new Error("failed to get value for key " + r);
                  "ASCII" === a &&
                    "string" == typeof l &&
                    !1 === ut(l, "\0") &&
                    (l += "\0");
                  ...
                  t.writeUshort(e, i, o),
                    ...
                    t.writeUint(e, i, f),
                    (i += 4);
                  let h = [-1, 1, 1, 2, 4, 8, 0, 0, 0, 0, 0, 0, 8][u] * f,
                    d = i;
                  h > 4 && (t.writeUint(e, i, s), (d = s)),
                    "ASCII" === a
                      ? t.writeASCII(e, d, l)
                      : "SHORT" === a
                      ? lt(f, (r) => {
                      ...
                      : "RATIONAL" === a
                      ? lt(f, (r) => {
                          t.writeUint(e, d + 8 * r, Math.round(1e4 * l[r])),
                            t.writeUint(e, d + 8 * r + 4, 1e4);
                        })
                      : "DOUBLE" === a &&
                        lt(f, (r) => {
      ...
      function bt(t, e) {
        let r, n, i, o;
        "number" == typeof t[0]
          ? ((r = e.height || e.ImageLength),
            (i = e.width || e.ImageWidth),
            (n = t.length / (r * i)),
            (o = t))
          : ((n = t.length),
            (r = t[0].length),
          ...
          (e.ImageWidth = i),
          delete e.width,
          e.BitsPerSample || (e.BitsPerSample = lt(n, () => 8)),
          mt.forEach((t) => {
            const r = t[0];
            if (!e[r]) {
              const n = t[1];
          ...
          e.PhotometricInterpretation ||
            (e.PhotometricInterpretation =
              3 === e.BitsPerSample.length ? 2 : 1),
          e.SamplesPerPixel || (e.SamplesPerPixel = [n]),
          e.StripByteCounts || (e.StripByteCounts = [n * r * i]),
          e.ModelPixelScale || (e.ModelPixelScale = [360 / i, 180 / r, 0]),
          e.SampleFormat || (e.SampleFormat = lt(n, () => 1));
        const s = Object.keys(e)
          .filter((t) => ut(t, "GeoKey"))
          .sort((t, e) => dt[t] - dt[e]);
        if (!e.GeoKeyDirectory) {
          const t = [1, 1, 0, s.length];
          s.forEach((r) => {
            const n = Number(dt[r]);
            let i, o, s;
            t.push(n),
              "SHORT" === c[n]
                ? ((i = 1), (o = 0), (s = e[r]))
                : "GeogCitationGeoKey" === r
                ? ((i = e.GeoAsciiParams.length),
                  (o = Number(dt.GeoAsciiParams)),
                  (s = 0))
                : console.log(
                    "[geotiff.js] couldn't get TIFFTagLocation for " + r
                  ),
              t.push(o),
              t.push(i),
              t.push(s);
        ...
        const a = ((t) => {
          ...
          for (const r in t)
            "StripOffsets" !== r &&
              (dt[r] || console.error(r, "not in name2code:", Object.keys(dt)),
              (e[dt[r]] = t[r]));
          return e;
        })(e);
        return ((t, e, r, n) => {
          if (null == r)
            throw new Error("you passed into encodeImage a width of type " + r);
          if (null == e)
          ...
          const o = new Uint8Array(gt([i])),
            s = new Uint8Array(t),
            a = i[277],
            u = new Uint8Array(1e3 + e * r * a);
          return (
            lt(o.length, (t) => {
              u[t] = o[t];
            }),
      ...
      function St(t, e, r, n) {
        ...
        if (e !== h.RATIONAL && e !== h.SRATIONAL)
          for (let e = 0; e < r; ++e) i[e] = o.call(t, n + e * s);
        else
          for (let e = 0; e < r; e += 2)
            (i[e] = o.call(t, n + e * s)),
              (i[e + 1] = o.call(t, n + (e * s + 4)));
        return e === h.ASCII ? String.fromCharCode.apply(null, i) : i;
      }
      class At {
        constructor(t, e, r) {
          (this.fileDirectory = t),
            (this.geoKeyDirectory = e),
      ...
      class kt {
        async readRasters(t = {}) {
          ...
          let u = a;
          const c = await this.getImageCount(),
            l = a.getBoundingBox();
          if (e && s) throw new Error('Both "bbox" and "window" passed.');
          if (r || n) {
            if (e) {
              const [t, r] = a.getOrigin(),
                [n, i] = a.getResolution();
              s = [t + e[0] * n, r + e[1] * i, t + e[2] * n, r + e[3] * i];
            }
            const t = s || l;
            if (r) {
          ...
          if (i || o) {
            ...
            for (let e = 0; e < c; ++e) {
              const r = await this.getImage(e),
                { SubfileType: n, NewSubfileType: i } = r.fileDirectory;
              (0 === e || 2 === n || 1 & i) && t.push(r);
            }
            t.sort((t, e) => t.getWidth() - e.getWidth());
            for (let e = 0; e < t.length; ++e) {
              const r = t[e],
                n = (l[2] - l[0]) / r.getWidth(),
                s = (l[3] - l[1]) / r.getHeight();
              if (((u = r), (i && i > n) || (o && o > s))) break;
            }
          }
          let f = e;
          if (s) {
            const [t, e] = a.getOrigin(),
              [r, n] = u.getResolution(a);
            (f = [
              Math.round((s[0] - t) / r),
              Math.round((s[1] - e) / n),
              Math.round((s[2] - t) / r),
          ...
          return u.readRasters({ ...t, window: f });
        }
      }
      class Tt extends kt {
        ...
        async getSlice(t, e) {
          ...
          return new K(
            await this.source.fetch(t, void 0 !== e ? e : r),
            t,
            this.littleEndian,
            this.bigTiff
          );
        ...
        async parseFileDirectoryAt(t) {
          const e = this.bigTiff ? 20 : 12,
            r = this.bigTiff ? 8 : 2;
          let n = await this.getSlice(t);
          const i = this.bigTiff ? n.readUint64(t) : n.readUint16(t),
            o = i * e + (this.bigTiff ? 16 : 6);
          n.covers(t, o) || (n = await this.getSlice(t, o));
          const s = {};
          let u = t + (this.bigTiff ? 8 : 2);
          for (let t = 0; t < i; u += e, ++t) {
            const t = n.readUint16(u),
              e = n.readUint16(u + 2),
              r = this.bigTiff ? n.readUint64(u + 4) : n.readUint32(u + 4);
            let i, o;
            const c = _t(e),
              f = u + (this.bigTiff ? 12 : 8);
            if (c * r <= (this.bigTiff ? 8 : 4)) i = St(n, e, r, f);
            else {
              const t = n.readOffset(f),
                o = _t(e) * r;
              if (n.covers(t, o)) i = St(n, e, r, t);
              else {
                i = St(await this.getSlice(t, o), e, r, t);
              }
            }
            (o =
              1 === r &&
          ...
          const c = (function (t) {
              ...
              for (let n = 4; n <= 4 * e[3]; n += 4) {
                ...
                if (o) {
                  ...
                  "string" == typeof c
                    ? (c = c.substring(u, u + s - 1))
                    : c.subarray &&
                      ((c = c.subarray(u, u + s)), 1 === s && (c = c[0]));
                } else c = u;
                r[i] = c;
              }
              return r;
            })(s),
            f = n.readOffset(t + r + e * i);
          return new At(s, c, f);
        }
        async requestIFD(t) {
          ...
          if (0 === t)
            return (
              (this.ifdRequests[t] = this.parseFileDirectoryAt(
                this.firstIFDOffset
              )),
              this.ifdRequests[t]
            );
        ...
        async getGhostValues() {
          ...
          const e = "GDAL_STRUCTURAL_METADATA_SIZE=",
            r = e.length + 100;
          let n = await this.getSlice(t, r);
          if (e === St(n, h.ASCII, e.length, t)) {
            const e = St(n, h.ASCII, r, t).split("\n")[0],
              i = Number(e.split("=")[1].split(" ")[0]) + e.length;
      ...
      class Ot extends kt {
        constructor(t, e) {
          super(),
            (this.mainFile = t),
            (this.overviewFiles = e),
            (this.imageFiles = [t].concat(e)),
        ...
        async parseFileDirectoriesPerFile() {
          const t = [
            ...
            this.overviewFiles.map((t) =>
              t.parseFileDirectoryAt(t.firstIFDOffset)
            )
          );
          return (
            (this.fileDirectoriesPerFile = await Promise.all(t)),
        ...
        async getImageCount() {
          ...
          const t = [this.mainFile.getImageCount()].concat(
            this.overviewFiles.map((t) => t.getImageCount())
          );
          return (
            (this.imageCounts = await Promise.all(t)),
            (this.imageCount = this.imageCounts.reduce((t, e) => t + e, 0)),
            this.imageCount
          );
        }
      }
      ...
      async function Rt(t) {
        return Tt.fromSource(
          ((e = t),
          {
            fetch: async (t, r) =>
              new Promise((n, i) => {
                const o = e.slice(t, t + r),
                  s = new FileReader();
                (s.onload = (t) => n(t.target.result)),
                  (s.onerror = i),
      ...
      async function jt(t, e = [], r = {}) {
        const n = await Tt.fromSource(ot(t, r)),
          i = await Promise.all(e.map((t) => Tt.fromSource(ot(t, r))));
        return new Ot(n, i);
      }
    ...
    function (t, e, r) {
      function n(t, e) {
        ...
        function f() {
          for (var e = []; t[r]; )
            if (t.charCodeAt(r) == i) {
              if (t.charCodeAt(r + 1) === a)
                return (r = t.indexOf(">", r)) + 1 && (r += 1), e;
        ...
        var p = e.noChildNodes || ["img", "br", "input", "meta", "link"];
        function y() {
          r++;
          const e = d(),
            n = {};
          ...
          for (; t.charCodeAt(r) !== o && t[r]; ) {
            ...
            if ((s > 64 && s < 91) || (s > 96 && s < 123)) {
              ...
              if (h === c || h === l) {
                var y = g();
                if (-1 === r) return { tagName: e, attributes: n, children: i };
              } else (y = null), r--;
              n[u] = y;
            }
            r++;
        ...
        if (void 0 !== e.attrValue) {
          ...
          for (
            ...
            ((m = void 0),
            (m = new RegExp(
              "\\s" + e.attrName + "\\s*=['\"]" + e.attrValue + "['\"]"
            ).exec(t)),
            (r = m ? m.index : -1));

          )
            -1 !== (r = t.lastIndexOf("<", r)) && b.push(y()),
              (t = t.substr(r)),
              (r = 0);
        } else b = e.parseNode ? y() : f();
        return (
          e.filter && (b = n.filter(b, e.filter)), e.setPos && (b.pos = r), b
        );
      }
      (n.simplify = function (t) {
        ...
        for (var r in (t.forEach(function (t) {
          if ("object" == typeof t) {
            ...
            e[t.tagName].push(r),
              t.attributes && (r._attributes = t.attributes);
          }
        }),
        e))
          1 == e[r].length && (e[r] = e[r][0]);
        return e;
      }),
          ...
          function r(t) {
            if (t)
              for (var r = 0; r < t.length; r++)
                "string" == typeof t[r] ? (e += t[r].trim()) : n(t[r]);
          }
          function n(t) {
            for (var n in ((e += "<" + t.tagName), t.attributes))
              null === t.attributes[n]
                ? (e += " " + n)
                : -1 === t.attributes[n].indexOf('"')
                ? (e += " " + n + '="' + t.attributes[n].trim() + '"')
                : (e += " " + n + "='" + t.attributes[n].trim() + "'");
        ...
        (n.parseStream = function (t, e) {
          if (
            ("string" == typeof e && (e = e.length + 2), "string" == typeof t)
          ) {
            var i = r(25);
            (t = i.createReadStream(t, { start: e })), (e = 0);
          }
          var o = e,
            s = "";
          return (
            t.on("data", function (e) {
              ...
              for (var r = 0; ; ) {
                ...
                if ("/" !== s[o + 1]) {
                  var i = n(s, { pos: o - 1, parseNode: !0, setPos: !0 });
                  if ((o = i.pos) > s.length - 1 || o < r)
                    return (s = s.slice(r)), (o = 0), void (r = 0);
                  t.emit("xml", i), (r = o);
                } else (o += 1), (r = pos);
              }
            }),
        ...
        (n.transformStream = function (t) {
          ...
          return e({ readableObjectMode: !0 }, function (t, e, r) {
            ...
            for (var s = 0; ; ) {
              ...
              if ("/" !== o[i + 1]) {
                var a = n(o, { pos: i - 1, parseNode: !0, setPos: !0 });
                if ((i = a.pos) > o.length - 1 || i < s)
                  return (o = o.slice(s)), (i = 0), (s = 0), r();
                this.push(a), (s = i);
              } else (i += 1), (s = pos);
            }
            r();
    ...
    function (t, e, r) {
      ...
      function f(t) {
        ...
        if (
          ...
          e.dictionary &&
            ...
            e.raw &&
              (r = n.inflateSetDictionary(this.strm, e.dictionary)) !== s.Z_OK))
        )
          throw new Error(a[r]);
      }
      function h(t, e) {
      ...
      (f.prototype.push = function (t, e) {
        ...
        do {
          if (
            (0 === h.avail_out &&
              ((h.output = new i.Buf8(d)), (h.next_out = 0), (h.avail_out = d)),
            (r = n.inflate(h, s.Z_NO_FLUSH)) === s.Z_NEED_DICT &&
              p &&
              (r = n.inflateSetDictionary(this.strm, p)),
            r === s.Z_BUF_ERROR && !0 === y && ((r = s.Z_OK), (y = !1)),
    ...
    function (t, e, r) {
      ...
      class i extends n.a {
        constructor() {
          super(
            (t) => (this._observers.add(t), () => this._observers.delete(t))
          ),
          ...
          return t
            ...
            .then(function (t) {
              return t.map(function (t) {
                return (0, u.unflatten)(t, { height: a, width: s });
              });
            });
        }
        var d = (function () {
            function t(r, i, o) {
              !(function (t, e) {
                ...
                o && console.log("starting GeoRaster.constructor with", r, i),
                (this._web_worker_is_available =
                  "undefined" != typeof window && void 0 !== window.Worker),
                (this._blob_is_available = "undefined" != typeof Blob),
                (this._url_is_available = "undefined" != typeof URL),
                "object" === (void 0 === r ? "undefined" : n(r)) &&
                  r.constructor &&
                  "Buffer" === r.constructor.name &&
                  !1 === e.isBuffer(r) &&
                  (r = new e(r)),
                "string" == typeof r
                  ? (o && console.log("data is a url"),
                    (this._data = r),
                    (this._url = r),
                  ...
                  : void 0 !== e && e.isBuffer(r)
                  ? (o && console.log("data is a buffer"),
                    (this._data = r.buffer.slice(
                      r.byteOffset,
                  ...
                  : Array.isArray(r) &&
                    ...
                    (this._metadata = i)),
                o && console.log("this after construction:", this);
            }
            return (
              i(t, [
                {
                  ...
                  value: function (t) {
                    var e = this;
                    if (
                      (t && console.log("starting preinitialize"), this._url)
                    ) {
                      var r = this._url + ".ovr";
                      return (function (t) {
                        try {
                          return (0, o.default)(t, { method: "HEAD" })
                            .then(function (t) {
                              return 200 === t.status;
                            })
                            .catch(function (t) {
                        ...
                        return (
                          t && console.log("overview exists:", n),
                          n
                            ? (0, c.fromUrls)(e._url, [r], {
                                cache: !0,
                                forceXHR: !1,
                              })
                            : (0, c.fromUrl)(e._url, {
                  ...
                  value: function (t) {
                    ...
                    return this.preinitialize(t).then(function (r) {
                      return new Promise(function (n, i) {
                        if (
                          (t && console.log("starting GeoRaster.initialize"),
                          t && console.log("this", e),
                          "object" === e.rasterType ||
                            "geotiff" === e.rasterType ||
                            "tiff" === e.rasterType)
                        )
                          if (e._web_worker_is_available) {
                            var o = new s.default();
                            (o.onmessage = function (i) {
                              t &&
                                console.log("main thread received message:", i);
                              var o = i.data;
                              ...
                              t && console.log("about to postMessage"),
                              e._data instanceof ArrayBuffer
                                ? o.postMessage(
                                    {
                                      data: e._data,
                            ...
                            t && console.log("web worker is not available"),
                              (0, a.default)(
                                {
                                  data: e._data,
                                  rasterType: e.rasterType,
                                ...
                                .then(function (i) {
                                  t && console.log("result:", i),
                                    e._url &&
                                      ((i._geotiff = r),
                                      (i.getValues = function (t) {
                                        return h(this._geotiff, t);
                                      })),
          ...
          p = function (t, e, r) {
            if (
              (r && console.log("starting parseGeoraster with ", t, e),
              void 0 === t)
            ) {
              throw Error(
                "[Georaster.parseGeoraster] Error. You passed in undefined to parseGeoraster. We can't make a raster out of nothing!"
              );
            }
            return new d(t, e, r).initialize(r);
          };
        void 0 !== t.exports && (t.exports = p),
          "undefined" != typeof window
            ? (window.parseGeoraster = p)
            : "undefined" != typeof self && (self.parseGeoraster = p);
    ...
    function (t, e, r) {
      ...
      e.default = function (t, e) {
        return new Promise(function (r, o) {
          try {
            e && console.log("starting parseData with", t),
              e &&
                console.log(
                  "\tGeoTIFF:",
                  "undefined" == typeof GeoTIFF ? "undefined" : i(GeoTIFF)
                );
            var u = {},
              c = void 0,
              h = void 0;
            if ("object" === t.rasterType)
              (u.values = t.data),
                (u.height = c = t.metadata.height || u.values[0].length),
                (u.width = h = t.metadata.width || u.values[0][0].length),
                (u.pixelHeight = t.metadata.pixelHeight),
                (u.pixelWidth = t.metadata.pixelWidth),
                (u.projection = t.metadata.projection),
                (u.xmin = t.metadata.xmin),
                (u.ymax = t.metadata.ymax),
                (u.noDataValue = t.metadata.noDataValue),
                (u.numberOfRasters = u.values.length),
                (u.xmax = u.xmin + u.width * u.pixelWidth),
                (u.ymin = u.ymax - u.height * u.pixelHeight),
                (u._data = null),
                r(f(u));
              ...
              "url" === t.sourceType
                ? (d = s.fromUrl)
                : "Blob" === t.sourceType && (d = s.fromBlob),
                e && console.log("data.rasterType is geotiff"),
                r(
                  d(t.data).then(function (r) {
                    return (
                      e && console.log("geotiff:", r),
                      r.getImage().then(function (r) {
                        try {
                          e && console.log("image:", r);
                          var i = r.fileDirectory,
                            s = r.getGeoKeys() || {},
                            d = s.GeographicTypeGeoKey,
                            p = s.ProjectedCSTypeGeoKey;
                          (u.projection = p || d || t.metadata.projection),
                            e && console.log("projection:", u.projection),
                            (u.height = c = r.getHeight()),
                            e && console.log("result.height:", u.height),
                            (u.width = h = r.getWidth()),
                            e && console.log("result.width:", u.width);
                          var y = r.getResolution(),
                            g = n(y, 2),
                            m = g[0],
                            b = g[1];
                          (u.pixelHeight = Math.abs(b)),
                            (u.pixelWidth = Math.abs(m));
                          var v = r.getOrigin(),
                            w = n(v, 2),
                            x = w[0],
                            _ = w[1];
                          return (
                            (u.xmin = x),
                            (u.xmax = u.xmin + h * u.pixelWidth),
                            (u.ymax = _),
                            (u.ymin = u.ymax - c * u.pixelHeight),
                            (u.noDataValue = i.GDAL_NODATA
                              ? parseFloat(i.GDAL_NODATA)
                              : null),
                            (u.numberOfRasters = i.SamplesPerPixel),
                            i.ColorMap && (u.palette = (0, a.getPalette)(r)),
                            "url" !== t.sourceType
                              ? r.readRasters().then(function (t) {
                                  return (
                                    (u.values = t.map(function (t) {
                                      return (0,
                                      l.unflatten)(t, { height: c, width: h });
                                    })),
                                    f(u)
                                  );
                                })
                          ...
                          o(t),
                            console.error(
                              "[georaster] error parsing georaster:",
                              t
                            );
                        }
                      })
      ...
      (function (e) {
        ...
        i(o, n),
          ...
          (t.exports.obj = a(function (t, e, r) {
            var n = new o(
              Object.assign({ objectMode: !0, highWaterMark: 16 }, t)
            );
            return (n._transform = e), r && (n._flush = r), n;
          }));
      }).call(this, r(8));
    ...
    function (t, e, r) {
      ...
      function m(t) {
        if (g) {
          ...
          for (a(1, t.lens, 0, 288, p, 0, t.work, { bits: 9 }), e = 0; e < 32; )
            t.lens[e++] = 5;
            ...
            switch (r.mode) {
                ...
                if (
                  ...
                  x &&
                    (r.head &&
                      ...
                      n.arraySet(r.head.extra, c, f, x, P)),
                    512 & r.flags && (r.check = o(r.check, c, x, f)),
                    (d -= x),
                    (f += x),
                    (r.length -= x)),
                  r.length)
              ...
              case 18:
                ...
                if (
                  ...
                  (r.lenbits = 7),
                  (R = { bits: r.lenbits }),
                  (I = a(0, r.lens, 0, 19, r.lencode, 0, r.work, R)),
                  (r.lenbits = R.bits),
                  I)
                ) {
              ...
              case 19:
                for (; r.have < r.nlen + r.ndist; ) {
                  for (
                    ;
                    (E =
                      ((M = r.lencode[y & ((1 << r.lenbits) - 1)]) >>> 16) &
                      255),
                      (k = 65535 & M),
                      !((A = M >>> 24) <= g);
                ...
                if (
                  ((r.lenbits = 9),
                  (R = { bits: r.lenbits }),
                  (I = a(1, r.lens, 0, r.nlen, r.lencode, 0, r.work, R)),
                  (r.lenbits = R.bits),
                  I)
                ) {
                ...
                if (
                  ...
                  (R = { bits: r.distbits }),
                  (I = a(2, r.lens, r.nlen, r.ndist, r.distcode, 0, r.work, R)),
                  (r.distbits = R.bits),
                  I)
                ) {
              ...
              case 21:
                ...
                for (
                  r.back = 0;
                  (E =
                    ((M = r.lencode[y & ((1 << r.lenbits) - 1)]) >>> 16) & 255),
                    (k = 65535 & M),
                    !((A = M >>> 24) <= g);
                ...
                if (
                  ((y >>>= A), (g -= A), (r.back += A), (r.length = k), 0 === E)
                ) {
                  r.mode = 26;
                  break;
                }
              ...
              case 23:
                for (
                  ;
                  (E =
                    ((M = r.distcode[y & ((1 << r.distbits) - 1)]) >>> 16) &
                    255),
                    (k = 65535 & M),
                    !((A = M >>> 24) <= g);
    ...
    function (t, e, r) {
      ...
      t.exports = function (t, e, r, u, c, l, f, h) {
        ...
        for (;;) {
          ...
          if (S > T && (R & g) !== y) {
            for (
              0 === C && (C = T), m += E, P = 1 << (O = S - C);
              O + C < k && !((P -= L[O + C]) <= 0);

            )
              O++, (P <<= 1);
            if (((I += 1 << O), (1 === t && I > 852) || (2 === t && I > 592)))
              return 1;
            c[(y = R & g)] = (T << 24) | (O << 16) | (m - l) | 0;
          }
        }
        return (
          0 !== R && (c[m + R] = ((S - C) << 24) | (64 << 16) | 0),
          (h.bits = T),
          0
        );
      };
        ...
        /*! https://mths.be/punycode v1.4.1 by @mathias */ !(function (o) {
              ...
              for (
                ...
                i >= g && y("invalid-input"),
                  ((c =
                    ...
                    y("overflow"),
                  (m += c * s),
                  !(c < (l = a <= w ? 1 : a >= w + 26 ? 26 : a - w));
                a += 36
              )
                s > d(u / (f = 36 - l)) && y("overflow"), (s *= f);
              (w = x(m - o, (e = p.length + 1), 0 == o)),
                d(m / e) > u - b && y("overflow"),
                (b += d(m / e)),
                (m %= e),
                p.splice(m++, 0, b);
            }
          ...
          function S(t) {
            var e,
              ...
              S = [];
            for (
              g = (t = b(t)).length, e = 128, r = 0, o = 72, s = 0;
              s < g;
              ++s
            )
              (h = t[s]) < 128 && S.push(p(h));
            for (n = i = S.length, i && S.push("-"); n < g; ) {
              for (a = u, s = 0; s < g; ++s)
                (h = t[s]) >= e && h < a && (a = h);
              for (
                a - e > d((u - r) / (m = n + 1)) && y("overflow"),
                  r += (a - e) * m,
                  e = a,
                  s = 0;
                s < g;
    ...
    function (t, e, r) {
      ...
      var n = r(144),
        ...
        p = {},
        y = function t(e, r, o, s, a, c, f, h, y, g, m, b, v, w, x, _) {
          for (
            var S, A = e, E = _, k = 0, T = !1;
            void 0 !== (E = E.get(p)) && !T;
          ...
          if (
            ...
            return f
              ? [
                  v(w ? r : f(r, d.encoder, x, "key", b)) +
                    "=" +
                    v(f(A, d.encoder, x, "value", b)),
                ]
              : [v(r) + "=" + v(String(A))];
          var C,
            P = [];
          ...
          if ("comma" === o && u(A))
            w && f && (A = i.maybeMap(A, f)),
              (C = [{ value: A.length > 0 ? A.join(",") || null : void 0 }]);
          else if (u(h)) C = h;
          else {
            var I = Object.keys(A);
            C = y ? I.sort(y) : I;
          ...
          for (
            var R = s && u(A) && 1 === A.length ? r + "[]" : r, j = 0;
            j < C.length;
            ++j
          ) {
            var M = C[j],
              L = "object" == typeof M && void 0 !== M.value ? M.value : A[M];
            if (!c || null !== L) {
              var F = u(A)
                ? "function" == typeof o
                  ? o(R, M)
    ...
    function (t, e, r) {
      ...
      t.exports = function () {
        return (
          { __proto__: n }.foo === n.foo && !({ __proto__: null } instanceof i)
        );
      };
    },
    function (t, e, r) {
    ...
    function (t, e, r) {
      ...
      t.exports = function t(e, r, n, i) {
        ...
        if (H(a, "numericSeparator") && "boolean" != typeof a.numericSeparator)
          throw new TypeError(
        ...
        function F(e, r, o) {
          if ((r && (i = E.call(i)).push(r), o)) {
            var s = { depth: a.depth };
            return (
              H(a, "quoteStyle") && (s.quoteStyle = a.quoteStyle),
              t(e, s, n + 1, i)
            );
          }
          return t(e, a, n + 1, i);
        ...
        if (
          ...
          for (
            ...
            et += " " + rt[nt].name + "=" + D(U(rt[nt].value), "double", a);
          return (
            (et += ">"),
        ...
        if (
          ...
          return "cause" in Error.prototype ||
            ...
            : "{ [" +
                String(e) +
                "] " +
                A.call(S.call("[cause]: " + F(e.cause), ot), ", ") +
                " }";
        }
        if ("object" == typeof e && u) {
          if (N && "function" == typeof e[N] && L)
        ...
        for (var u in t)
          H(t, u) &&
            ((r && String(Number(u)) === u && u < t.length) ||
              (P && o["$" + u] instanceof Symbol) ||
              (_.call(/[^\w$]/, u)
                ? n.push(e(u, t) + ": " + e(t[u], t))
                : n.push(u + ": " + e(t[u], t))));
        if ("function" == typeof O)
          for (var c = 0; c < s.length; c++)
            R.call(t, s[c]) && n.push("[" + e(s[c]) + "]: " + e(t[s[c]], t));
        return n;
      }
    },
    function (t, e) {},
                      ...
                      if (r !== d) {
                        ...
                        -1 === v
                          ...
                          : ((y = e.decoder(
                            ...
                            (g = n.maybeMap(u(m.slice(v + 1), e), function (t) {
    ...
    function (t, e) {
      t.exports = {
        getPalette: (t, { debug: e = !1 } = { debug: !1 }) => {
          e && console.log("starting getPalette with image", t);
          const { fileDirectory: r } = t,
            {
              BitsPerSample: n,
              ColorMap: i,
              ImageLength: o,
          ...
          if (!i)
            throw new Error(
              "[geotiff-palette]: the image does not contain a color map, so we can't make a palette."
            );
          const l = Math.pow(2, n);
          e && console.log("[geotiff-palette]: count:", l);
          const f = i.length / 3;
          if ((e && console.log("[geotiff-palette]: bandSize:", f), f !== l))
            throw new Error(
              "[geotiff-palette]: can't handle situations where the color map has more or less values than the number of possible values in a raster"
            );
          const h = f,
            d = h + f,
            p = [];
      ...
      var n,
        ...
        u = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        c = (t, e) => i(t, "name", { value: e, configurable: !0 });
      const l = r(157),
        f = r(192),
        h = r(194),
        d = c((t) => new Array(t).fill(0).map((t, e) => e), "range");
      function p(t, e = {}) {
        var r = e,
          {
            bands: n,
          ...
          m = ((t, e) => {
            ...
            return r;
          })(r, ["bands", "height", "precise", "stats", "width", "layout"]);
        ...
        const b = f({ bands: n, data: t, height: i, layout: g, width: y });
        null != n || (n = b.bands),
          null != i || (i = b.height),
          null != g || (g = b.layout),
          null != y || (y = b.width);
        const v = d(n).map((e) => {
          ...
          if (["[band][row,column]", "[band][column,row]"].includes(g))
            ...
            const o = { band: [e, e] },
              s = { band: n, column: y, row: i };
            r = h.iterClip({ data: t, layout: g, rect: o, sizes: s });
          }
          return l(r, f);
        });
        return { depth: n, height: i, width: y, bands: v };
      }
      c(p, "calcImageStats"),
        void 0 !==
          (n = function () {
        ...
        (t.exports = p),
        (t.exports.default = p),
        (t.exports.calcImageStats = p),
        "object" == typeof self && (self.calcImageStats = p),
        "object" == typeof window && (self.calcImageStats = p);
    },
    function (t, e, r) {
      var n;
      const { getOrCreateIterator: i } = r(72),
        {
          add: o,
          compare: s,
          divide: a,
      ...
      function y(
        t,
        {
          ...
          calcUniques: P = !0,
          precise: I = !1,
          precise_max_decimal_digits: R = 100,
          stats: j,
        } = { debugLevel: 0 }
      ) {
        j &&
          (j.forEach((t) => {
            [
              ...
              console.warn(`[calc-stats] skipping unknown stat "${t}"`);
          }),
          (y = j.includes("count")),
          (g = j.includes("histogram")),
          (m = j.includes("invalid")),
          (b = j.includes("max")),
          (v = j.includes("mean")),
          (w = j.includes("median")),
          (x = j.includes("min")),
          (_ = j.includes("mode")),
          (S = j.includes("modes")),
          (A = j.includes("product")),
          (E = j.includes("range")),
          (k = j.includes("std")),
          (T = j.includes("sum")),
          (O = j.includes("valid")),
          (C = j.includes("variance")),
          (P = j.includes("uniques")));
        const M = i(t);
        let L,
          F,
          N,
          D = g || w || _ || S || C || k || P,
          U = y || v || w || A || O || C || k || "function" == typeof d,
          B = y || m || "function" == typeof d,
          G = T || v || C || k,
          q = x || E,
          z = b || E,
          H = A,
        ...
        (Z = I
          ? (t) => {
              (t = t.toString()),
                U && W++,
                !q || (void 0 !== L && "<" !== s(t, L)) || (L = t),
                !z || (void 0 !== F && ">" !== s(t, F)) || (F = t),
                H && (N = 1 === W ? t : c(N, t)),
                G && (K = o(K, t)),
                D && (t in Y ? Y[t].ct++ : (Y[t] = { n: t.toString(), ct: 1 }));
            }
          : (t) => {
              U && W++,
                q && (void 0 === L || t < L) && (L = t),
                ...
                H && (N = 1 === W ? t : N * t),
                G && (K += t),
                D && (t in Y ? Y[t].ct++ : (Y[t] = { n: t, ct: 1 }));
            }),
          (X =
            "number" == typeof n && "function" == typeof d
              ? (t) => {
                  $++,
                    "number" != typeof t ||
                    isNaN(t) ||
                    t === n ||
                    !0 !== d({ valid: W, index: $, value: t })
                      ? B && V++
                      : Z(t);
                }
              : "number" == typeof n
        ...
        const Q = () => {
          const t = {};
          if (
            (y && (t.count = I ? o(V.toString(), W.toString()) : V + W),
            O && (t.valid = I ? W.toString() : W),
            m && (t.invalid = I ? V.toString() : V),
            w && (t.median = p.calculate({ counts: Y, precise: I, total: W })),
            x && (t.min = L),
            b && (t.max = F),
            A && (t.product = N),
            T && (t.sum = K),
            E && (t.range = I ? h(F.toString(), L.toString()) : F - L),
            v || C || k)
          ) {
            ...
            if ((v && (t.mean = e), C || k)) {
              const r = (({
                ...
                if (n) {
                  r = r.toString();
                  const n = Object.values(e).reduce((t, { n: e, ct: n }) => {
                ...
                return (
                  Object.values(e).reduce(
                    (t, { n: e, ct: n }) => t + n * Math.pow(e - r, 2),
                    0
                  ) / t
                );
              })({ count: W, histogram: Y, mean_value: e, precise: I });
              C && (t.variance = r),
                k &&
                  (t.std = I ? Math.sqrt(Number(r)).toString() : Math.sqrt(r));
            }
          }
          if (
            (g &&
              (I &&
                Object.values(Y).forEach((t) => {
                  t.ct = t.ct.toString();
                }),
              (t.histogram = Y)),
            _ || S)
            ...
            for (let t in Y) {
              const { n: n, ct: i } = Y[t];
              i === e
                ? r.push(I ? n.toString() : n)
                : i > e && ((e = i), (r = [I ? n.toString() : n]));
            }
            S && (t.modes = r),
              _ &&
                (t.mode = I ? u(r) : r.reduce((t, e) => t + e, 0) / r.length);
          }
          return (
            P &&
              (t.uniques = I
      ...
      void 0 ===
        ...
        (t.exports = y),
        (t.exports.default = y),
        (t.exports.calcStats = y),
        "object" == typeof self && (self.calcStats = y),
        "object" == typeof window && (window.calcStats = y);
    },
    function (t, e, r) {
      "use strict";
      var n;
      ...
      void 0 ===
        ...
        (t.exports = N),
        (t.exports.default = N),
        "object" == typeof window && (window.preciso = N),
        "object" == typeof self && (self.preciso = N);
    },
    function (t, e, r) {
      "use strict";
      const n = r(0),
    ...
    function (t, e, r) {
      "use strict";
      const { MAX_SAFE_INTEGER: n } = r(74),
        { MAX_SAFE_INTEGER_LENGTH: i } = r(30),
        { PI: o } = r(162);
    ...
    function (t, e, r) {
      ...
      function u(t, { steps: e = 100, max_decimal_digits: r = 100 } = {}) {
        ...
        for (let t = 0; t < f; t++) {
          (u = n(y, "1")),
            (y = n(u, "1")),
            (d = s([d, h], { max_decimal_digits: r })),
            (p = s([p, u, y], { max_decimal_digits: r }));
    ...
    function (t, e, r) {
      ...
      function c(t, e) {
        ...
        return (
          e &&
            "number" == typeof e.max_decimal_digits &&
            ((b = s(b, { digits: e.max_decimal_digits })),
            (v = s(v, { digits: e.max_decimal_digits }))),
          { m: b, b: v }
        );
      }
      (t.exports = c), (t.exports.default = c);
    ...
    function (t, e, r) {
      ...
      function l(t, e) {
        ...
        const f = s(t, e, { max_decimal_places: 0 }),
          h = c(f),
          d = a(e, h);
        return r + u(t, d);
      }
    ...
    function (t, e, r) {
      ...
      function s(t, { max_decimal_digits: e }) {
        ...
        const r = o(t);
        return t.map((t) => n(t, r, { max_decimal_digits: e, ellipsis: !1 }));
      }
      (t.exports = s), (t.exports.default = s);
    },
    function (t, e, r) {
      ...
      function i(
        t,
        { direction: e = "ascending" } = { direction: "ascending" }
      ) {
    ...
    function (t, e, r) {
      ...
      function s({
        ...
        return void 0 !== t || void 0 !== a || e.length > s
          ? i({ counts: t, no_data: r, nums: e, precise: n, total: a })
          : o({ no_data: r, nums: e, precise: n });
      }
      const a = { calculate: s };
      void 0 ===
        (n = function () {
        ...
        (t.exports = a),
        (t.exports.default = { calculate: s }),
        "object" == typeof window && (window.mediana = a),
        "object" == typeof self && (self.mediana = a);
    },
    function (t, e, r) {
      const n = r(183),
        i = r(94);
      function o({
        ...
        (void 0 !== t && void 0 !== s) ||
          ({ counts: t, total: s } = n({ nums: e, no_data: r }));
        const a = Object.values(t).sort((t, e) => t.n - e.n),
          u = s / 2,
          c = a.length;
        if (0 !== c) {
    ...
    function (t, e) {
      function r({ nums: t, no_data: e }) {
        ...
        if (void 0 !== e)
          for (let o = 0; o < r; o++) {
            const r = t[o];
            r !== e && (i++, r in n ? n[r].ct++ : (n[r] = { n: r, ct: 1 }));
          }
        else
          for (let e = 0; e < r; e++) {
            const r = t[e];
            i++, r in n ? n[r].ct++ : (n[r] = { n: r, ct: 1 });
          }
    ...
    function (t, e, r) {
      ...
      t.exports = function (
        t,
        e,
        { max_decimal_digits: r = 100, ellipsis: a = !1 } = {}
      ) {
        "0" === t[0] && (t = t.substring(1)),
          "0" === e[0] && (e = e.substring(1));
        const u = t.indexOf("."),
        ...
        if (v === w) x = 0;
          ...
          v < w
            ? ((g = g.substring(0, v) + "." + g.substring(v)), (x = w - v))
            : 0 === v && ((g = "0." + g), (x = w));
    ...
    function (t, e, r) {
      ...
      void 0 ===
        ...
        (t.exports = o),
        (t.exports.default = o),
        (t.exports.guessImageLayout = o),
        "object" == typeof window && (window.guessImageLayout = o),
        "object" == typeof self && (self.guessImageLayout = o);
    },
    function (t, e) {
      t.exports = function (t) {
        const e = (t) =>
    ...
    function (t, e, r) {
      ...
      const u = (t) => t.match(/\[[^\]]+\]/g),
        ...
        h = (t) => {
          ...
          return 1 === e.length
            ? { type: "Vector", dim: e[0] }
            : { type: "Matrix", parts: e.map(h) };
        };
      function d(t) {
        const e = t.match(/[^ A-Za-z,\[\]]/g);
        if (e)
          throw new Error(
            "The following invalid characters were used: " +
              e.map((t) => `"${t}"`).join(", ")
          );
        return !0;
      }
      ...
      function y({
        ...
        const { dims: i } = r,
          o = i.length,
          a = m({ useLayoutCache: t, layout: r, sizes: n }),
          u = o - 1,
          c = r.summary.toString();
        if (c in s) {
          const t = { data: e };
          return (
            r.dims.map((e, r) => {
        ...
        return ({ point: t, value: r }) => {
          ...
          for (let e = 0; e < o; e++) {
            ...
            (c =
              "Vector" === s.type
                ? t[s.dim]
                : s.parts.reduce((e, { dim: r }) => e + a[r] * t[r], 0)),
              o ? (n[c] = r) : (n = n[c]);
          }
        };
      }
      function g({ rect: t = {} }) {
        if (t)
          for (let e in t) {
            ...
            if (n > i)
              throw new Error(
                `[xdim] uh oh. invalid range for "${e}".  Start of ${n} can't be greater than end of ${i}.`
              );
            if (n < 0)
              throw new Error(
                "[xdim] uh oh. invalid hyper-rectangle with start " + n
              );
          }
      }
      ...
      function b({
            ...
            for (let e = t.length - 1; e >= 0; e--) {
              ...
              if ("Vector" === o.type) {
                ...
                if (((r += u * n[t]), e > 0)) {
                  if (!(t in i))
                    throw new Error(
                      `you cannot calculate the location without knowing the size of the "${t}" dimension.`
                    );
                  u *= i[t];
                }
              }
        ...
        return { index: s, value: a, parent: o };
      }
      function v({ arr: t, fill: e, lens: r, arrayTypes: n }) {
        ...
        if (1 === r.length) {
          ...
          for (let o = 0; o < t.length; o++) {
            ...
            (t[o] = s), v({ arr: s, fill: e, lens: r.slice(1), arrayTypes: n });
          }
        return t;
      }
      function w({ fill: t, shape: e, arrayTypes: r }) {
        ...
        if (1 === e.length) {
          if (Array.isArray(r) && 1 !== r.length)
            throw new Error(
              "[xdim] shape and arrayTypes have different lengths"
            );
          const e = Array.isArray(r) ? r[0] : "Array";
          return new a[e](n).fill(t);
        }
        return v({
      ...
      function x({
        ...
        const o = e.dims.map((t) =>
          "Vector" === t.type
            ...
            ? t.parts.reduce((t, e) => {
                if (!(e.dim in n))
                  throw new Error(
                    `[xdim] could not find "${e.dim}" in sizes: { ${Object.keys(
                      n
                    ).join(", ")} }`
                  );
                return t * n[e.dim];
        ...
        return {
          data: w({ fill: t, shape: o, arrayTypes: i }),
          shape: o,
          arrayTypes: i,
        };
      }
      function _({ start: t = 0, end: e = 100 }) {
        ...
        return (
          (e += 1),
          i(function () {
            return r++, r === e ? { done: !0 } : { done: !1, value: r };
          })
        );
      }
      function S({ order: t, sizes: e, rect: r = {} }) {
        const n = Array.isArray(t)
            ? t
            : Object.keys(e).sort((t, r) => e[t] - e[r]),
          o = new Array(n.length),
          s = {};
        for (let t = 0; t < n.length - 1; t++) {
          const i = n[t],
            [a, u] = r[i] || [0, e[i] - 1];
          (o[t] = _({ start: a + 1, end: u })), (s[i] = a);
        }
        const a = n[n.length - 1],
          [u, c] = r[a] || [0, e[a] - 1];
        return (
          (o[o.length - 1] = _({ start: u, end: c })),
          (s[a] = u - 1),
          i(function () {
            for (let t = o.length - 1; t >= 0; t--) {
              ...
              if (!a) {
                for (let i = t + 1; i < o.length; i++) {
                  const t = n[i],
                    [a, u] = r[t] || [0, e[t] - 1];
                  (o[i] = _({ start: a + 1, end: u })), (s[t] = a);
                }
                return (s[n[t]] = i), { value: s, done: !1 };
              }
      ...
      t.exports = {
        ...
        iterClip: function ({
          ...
          const a = S({ order: r, sizes: o, rect: n });
          return i(function () {
            ...
            for (let e = 0; e < s; e++) {
              ...
              if (
                ((s =
                  "Vector" === o.type
                    ? t[o.dim]
                    : o.parts.reduce((e, { dim: r }) => e + a[r] * t[r], 0)),
                n)
              )
                return { index: s, parent: r, value: r[s] };
              r = r[s];
            }
          };
        },
        ...
        transform: function ({
          ...
          "string" == typeof r && (r = p(r, { useLayoutCache: o })),
            "string" == typeof n && (n = p(n, { useLayoutCache: o }));
          const { data: s } = x({ fill: e, layout: n, sizes: i }),
            a = y({ useLayoutCache: o, data: s, layout: n, sizes: i }),
            u = S({ sizes: i });
          for (point of u) {
            const { value: e } = b({
              data: t,
            ...
            if ("Vector" === a.type) u = n[a.dim];
              ...
              for (let r = t.length - 1; r >= 0; r--) {
                ...
                if (((u += e * n[s]), r > 0)) {
                  if (!(s in i))
                    throw new Error(
                      `you cannot calculate the location without knowing the size of the "${s}" dimension.`
                    );
                  e *= i[s];
                }
              }
        ...
        clip: function ({
          ...
          const u = Object.fromEntries(
              Object.entries(n).map(([t, [e, r]]) => [t, r - e + 1])
            ),
            { data: c } = x({ layout: r, sizes: u }),
            l = r.dims.length,
            f = (t, e) => {
    ...
    function (t, e) {
      t.exports = {
        1: function ({ point: t }) {
          const e = this.data,
            r = t[this.d0v0];
          return { parent: e, index: r, value: e[r] };
        },
        2: function ({ point: t }) {
          const e = this.data,
            r = this.m0v0 * t[this.d0v0] + this.m0v1 * t[this.d0v1];
          return { parent: e, index: r, value: e[r] };
        },
        3: function ({ point: t }) {
          const e = this.data,
            r =
              this.m0v0 * t[this.d0v0] +
              this.m0v1 * t[this.d0v1] +
              this.m0v2 * t[this.d0v2];
          return { parent: e, index: r, value: e[r] };
        },
        4: function ({ point: t }) {
          const e = this.data,
        ...
        5: function ({ point: t }) {
          const e = this.data,
            r =
              ...
              this.m0v2 * t[this.d0v2] +
              this.m0v3 * t[this.d0v3] +
              this.m0v4 * t[this.d0v4];
          return { parent: e, index: r, value: e[r] };
        },
        "1,1": function ({ point: t }) {
          const e = this.data[t[this.d0v0]],
            r = t[this.d1v0];
          return { parent: e, index: r, value: e[r] };
        },
        "1,2": function ({ point: t }) {
          const e = this.data[t[this.d0v0]],
            r = this.m1v0 * t[this.d1v0] + this.m1v1 * t[this.d1v1];
          return { parent: e, index: r, value: e[r] };
        },
        "1,3": function ({ point: t }) {
          const e = this.data[t[this.d0v0]],
            r =
              this.m1v0 * t[this.d1v0] +
              this.m1v1 * t[this.d1v1] +
              this.m1v2 * t[this.d1v2];
          return { parent: e, index: r, value: e[r] };
        },
        ...
        "1,5": function ({ point: t }) {
          const e = this.data[t[this.d0v0]],
            r =
              ...
              this.m1v2 * t[this.d1v2] +
              this.m1v3 * t[this.d1v3] +
              this.m1v4 * t[this.d1v4];
          return { parent: e, index: r, value: e[r] };
        },
        "1,1,1": function ({ point: t }) {
          const e = this.data[t[this.d0v0]][t[this.d1v0]],
            r = t[this.d2v0];
          return { parent: e, index: r, value: e[r] };
        },
        "1,1,2": function ({ point: t }) {
          const e = this.data[t[this.d0v0]][t[this.d1v0]],
            r = this.m2v0 * t[this.d2v0] + this.m2v1 * t[this.d2v1];
          return { parent: e, index: r, value: e[r] };
        },
        "1,1,3": function ({ point: t }) {
          const e = this.data[t[this.d0v0]][t[this.d1v0]],
            r =
              this.m2v0 * t[this.d2v0] +
              this.m2v1 * t[this.d2v1] +
              this.m2v2 * t[this.d2v2];
          return { parent: e, index: r, value: e[r] };
        },
        ...
        "1,1,5": function ({ point: t }) {
          const e = this.data[t[this.d0v0]][t[this.d1v0]],
            r =
              ...
              this.m2v2 * t[this.d2v2] +
              this.m2v3 * t[this.d2v3] +
              this.m2v4 * t[this.d2v4];
          return { parent: e, index: r, value: e[r] };
        },
        "1,1,1,1": function ({ point: t }) {
          const e = this.data[t[this.d0v0]][t[this.d1v0]][t[this.d2v0]],
            r = t[this.d3v0];
          return { parent: e, index: r, value: e[r] };
        },
        "1,1,1,2": function ({ point: t }) {
          const e = this.data[t[this.d0v0]][t[this.d1v0]][t[this.d2v0]],
            r = this.m3v0 * t[this.d3v0] + this.m3v1 * t[this.d3v1];
          return { parent: e, index: r, value: e[r] };
        },
        "1,1,1,3": function ({ point: t }) {
          const e = this.data[t[this.d0v0]][t[this.d1v0]][t[this.d2v0]],
            r =
              this.m3v0 * t[this.d3v0] +
              this.m3v1 * t[this.d3v1] +
              this.m3v2 * t[this.d3v2];
          return { parent: e, index: r, value: e[r] };
        },
        ...
        "1,1,1,5": function ({ point: t }) {
          const e = this.data[t[this.d0v0]][t[this.d1v0]][t[this.d2v0]],
            r =
              ...
              this.m3v2 * t[this.d3v2] +
              this.m3v3 * t[this.d3v3] +
              this.m3v4 * t[this.d3v4];
          return { parent: e, index: r, value: e[r] };
        },
        "1,1,1,1,1": function ({ point: t }) {
          const e =
              this.data[t[this.d0v0]][t[this.d1v0]][t[this.d2v0]][t[this.d3v0]],
            r = t[this.d4v0];
          return { parent: e, index: r, value: e[r] };
        },
        "1,1,1,1,2": function ({ point: t }) {
          const e =
              this.data[t[this.d0v0]][t[this.d1v0]][t[this.d2v0]][t[this.d3v0]],
            r = this.m4v0 * t[this.d4v0] + this.m4v1 * t[this.d4v1];
          return { parent: e, index: r, value: e[r] };
        },
        "1,1,1,1,3": function ({ point: t }) {
          const e =
              this.data[t[this.d0v0]][t[this.d1v0]][t[this.d2v0]][t[this.d3v0]],
            r =
              this.m4v0 * t[this.d4v0] +
              this.m4v1 * t[this.d4v1] +
              this.m4v2 * t[this.d4v2];
          return { parent: e, index: r, value: e[r] };
        },
    ...
    function (t, e) {
      t.exports = {
        ...
        "1,2": function ({ point: t, value: e }) {
          this.data[t[this.d0v0]][
            this.m1v0 * t[this.d1v0] + this.m1v1 * t[this.d1v1]
          ] = e;
        },
        ...
        "1,1,2": function ({ point: t, value: e }) {
          this.data[t[this.d0v0]][t[this.d1v0]][
            this.m2v0 * t[this.d2v0] + this.m2v1 * t[this.d2v1]
          ] = e;
        },
        ...
        "1,1,1,2": function ({ point: t, value: e }) {
          this.data[t[this.d0v0]][t[this.d1v0]][t[this.d2v0]][
            this.m3v0 * t[this.d3v0] + this.m3v1 * t[this.d3v1]
          ] = e;
        },
        ...
        "1,1,1,1,2": function ({ point: t, value: e }) {
          this.data[t[this.d0v0]][t[this.d1v0]][t[this.d2v0]][t[this.d3v0]][
            this.m4v0 * t[this.d4v0] + this.m4v1 * t[this.d4v1]
          ] = e;
        },
          ...
          const r = document.createElement("CANVAS"),
            n =
              e && e.height
                ...
                : Math.min(t.height, 100),
            i =
              e && e.width
                ? Math.min(t.width, e.width)
                : Math.min(t.width, 100);
          (r.height = n),
            (r.width = i),
            (r.style.minHeight = "200px"),
            (r.style.minWidth = "400px"),
            (r.style.maxWidth = "100%");
          const o = r.getContext("2d"),
            s = (function (t, e, r) {
              if (t.values) {
                const { noDataValue: n, mins: i, ranges: o, values: s } = t,
                  a = s.length,
                  u = t.width / e,
                  c = t.height / r,
                  l = new Uint8ClampedArray(e * r * 4);
                for (let t = 0; t < r; t++)
                  for (let r = 0; r < e; r++) {
                    const f = Math.round(t * c),
                      h = Math.round(r * u),
                      d = s.map((t) => {
                        try {
                          return t[f][h];
                    ...
                    if (d.every((t) => void 0 !== t && t !== n)) {
                      const n = t * (4 * e) + 4 * r;
                      if (1 === a) {
                        const t = Math.round(d[0]),
                          e = Math.round(((t - i[0]) / o[0]) * 255);
                        (l[n] = e),
                          (l[n + 1] = e),
                          (l[n + 2] = e),
                          (l[n + 3] = 255);
